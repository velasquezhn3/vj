-- MIGRACION CORREGIDA PARA SISTEMA DE RESERVAS DE CABAÑAS
-- Ejecuta este script UNA SOLA VEZ sobre tu base de datos SQLite

-- 1. Eliminar tabla Cabins si existe (¡Esto borrará todas las cabañas físicas previas!)
DROP TABLE IF EXISTS Cabins;

-- 2. Crear tabla física de cabañas (Cabins)
CREATE TABLE Cabins (
...
-- 3. Insertar cabañas físicas (3 Tortuga, 3 Delfín, 7 Tiburón)
...
-- 4. Modificar tabla Reservations para guardar el id físico de la cabaña
...
-- 5. Actualizar reservas existentes para que apunten a una cabaña física (solo si tienes datos previos)
...
-- 6. (Opcional) Eliminar columna antigua si ya migraste los datos
